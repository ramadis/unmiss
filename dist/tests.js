 ...
 * Assert interface
 */
var f=n(44);t.use(f)},function(e,t){e.exports={includeStack:!1,showDiff:!0,truncateThreshold:40,useProxy:!0,proxyExcludedKeys:["then","inspect","toJSON"]}},function(e,t){/*!
 * Chai - transferFlags utility
 * Copyright(c) 2012-2014 Jake Luer <jake@alogicalparadox.com>
 * MIT Licensed
 */
e.exports=function(e,t,n){var o=e.__flags||(e.__flags=Object.create(null));t.__flags||(t.__flags=Object.create(null)),n=3!==arguments.length||n;for(var r in o)(n||"object"!==r&&"ssfi"!==r&&"lockSsfi"!==r&&"message"!=r)&&(t.__flags[r]=o[r])}},function(e,t,n){"use strict";function o(e){return e&&e.__esModule?e:{default:e}}Object.defineProperty(t,"__esModule",{value:!0}),t.withMethodMissing=t.MethodMissingClass=void 0;var r=n(9),i=o(r),s=n(10),a=o(s);t.MethodMissingClass=i.default,t.withMethodMissing=a.default},function(e,t,n){function o(e,t,n,o){return r({showHidden:t,seen:[],stylize:function(e){return e}},e,void 0===n?2:n)}function r(e,n,o){if(n&&"function"==typeof n.inspect&&n.inspect!==t.inspect&&(!n.constructor||n.constructor.prototype!==n)){var b=n.inspect(o,e);return"string"!=typeof b&&(b=r(e,b,o)),b}var v=i(e,n);if(v)return v;if(x(n)){if("outerHTML"in n)return n.outerHTML;try{if(document.xmlVersion){return(new XMLSerializer).serializeToString(n)}var M=document.createElementNS("http://www.w3.org/1999/xhtml","_");M.appendChild(n.cloneNode(!1));var O=M.innerHTML.replace("><",">"+n.innerHTML+"<");return M.innerHTML="",O}catch(e){}}var j,S,P=w(n),N=e.showHidden?m(n):P;if(0===N.length||y(n)&&(1===N.length&&"stack"===N[0]||2===N.length&&"description"===N[0]&&"stack"===N[1])){if("function"==typeof n)return j=g(n),S=j?": "+j:"",e.stylize("[Function"+S+"]","special");if(h(n))return e.stylize(RegExp.prototype.toString.call(n),"regexp");if(d(n))return e.stylize(Date.prototype.toUTCString.call(n),"date");if(y(n))return s(n)}var k="",E=!1,A=!1,D=["{","}"];if(l(n)&&(A=!0,D=["[","]"]),p(n)&&(E=!0,D=["[","]"]),"function"==typeof n&&(j=g(n),S=j?": "+j:"",k=" [Function"+S+"]"),h(n)&&(k=" "+RegExp.prototype.toString.call(n)),d(n)&&(k=" "+Date.prototype.toUTCString.call(n)),y(n))return s(n);if(0===N.length&&(!E||0==n.length))return D[0]+k+D[1];if(o<0)return h(n)?e.stylize(RegExp.prototype.toString.call(n),"regexp"):e.stylize("[Object]","special");e.seen.push(n);var T;if(E)T=a(e,n,o,P,N);else{if(A)return c(n);T=N.map(function(t){return u(e,n,o,P,t,E)})}return e.seen.pop(),f(T,k,D)}function i(e,t){switch(typeof t){case"undefined":return e.stylize("undefined","undefined");case"string":var n="'"+JSON.stringify(t).replace(/^"|"$/g,"").replace(/'/g,"\\'").replace(/\\"/g,'"')+"'";return e.stylize(n,"string");case"number":return 0===t&&1/t==-1/0?e.stylize("-0","number"):e.stylize(""+t,"number");case"boolean":return e.stylize(""+t,"boolean");case"symbol":return e.stylize(t.toString(),"symbol")}if(null===t)return e.stylize("null","null")}function s(e){return"["+Error.prototype.toString.call(e)+"]"}function a(e,t,n,o,r){for(var i=[],s=0,a=t.length;s<a;++s)Object.prototype.hasOwnProperty.call(t,String(s))?i.push(u(e,t,n,o,String(s),!0)):i.push("");return r.forEach(function(r){r.match(/^\d+$/)||i.push(u(e,t,n,o,r,!0))}),i}function c(e){for(var t="[ ",n=0;n<e.length;++n){if(t.length>=v.truncateThreshold-7){t+="...";break}t+=e[n]+", "}return t+=" ]",-1!==t.indexOf(",  ]")&&(t=t.replace(",  ]"," ]")),t}function u(e,t,n,o,i,s){var a,c,u=Object.getOwnPropertyDescriptor(t,i);if(u&&(u.get?c=u.set?e.stylize("[Getter/Setter]","special"):e.stylize("[Getter]","special"):u.set&&(c=e.stylize("[Setter]","special"))),o.indexOf(i)<0&&(a="["+i+"]"),c||(e.seen.indexOf(t[i])<0?(c=null===n?r(e,t[i],null):r(e,t[i],n-1),c.indexOf("\n")>-1&&(c=s?c.split("\n").map(function(e){return"  "+e}).join("\n").substr(2):"\n"+c.split("\n").map(function(e){return"   "+e}).join("\n"))):c=e.stylize("[Circular]","special")),void 0===a){if(s&&i.match(/^\d+$/))return c;a=JSON.stringify(""+i),a.match(/^"([a-zA-Z_][a-zA-Z_0-9]*)"$/)?(a=a.substr(1,a.length-2),a=e.stylize(a,"name")):(a=a.replace(/'/g,"\\'").replace(/\\"/g,'"').replace(/(^"|"$)/g,"'"),a=e.stylize(a,"string"))}return a+": "+c}function f(e,t,n){var o=0;return e.reduce(function(e,t){return o++,t.indexOf("\n")>=0&&o++,e+t.length+1},0)>60?n[0]+(""===t?"":t+"\n ")+" "+e.join(",\n  ")+" "+n[1]:n[0]+t+" "+e.join(", ")+" "+n[1]}function l(e){return"object"==typeof e&&/\w+Array]$/.test(b(e))}function p(e){return Array.isArray(e)||"object"==typeof e&&"[object Array]"===b(e)}function h(e){return"object"==typeof e&&"[object RegExp]"===b(e)}function d(e){return"object"==typeof e&&"[object Date]"===b(e)}function y(e){return"object"==typeof e&&"[object Error]"===b(e)}function b(e){return Object.prototype.toString.call(e)}var g=n(16),m=n(17),w=n(27),v=n(2);e.exports=o;var x=function(e){return"object"==typeof HTMLElement?e instanceof HTMLElement:e&&"object"==typeof e&&"nodeType"in e&&1===e.nodeType&&"string"==typeof e.nodeName}},function(e,t,n){var o=n(2);/*!
 ...
 */
t.getOwnEnumerablePropertySymbols=n(19),/*!
 ...
 * Module dependancies
 */
var o=n(0),r=n(15),i=(n(5),n(18));e.exports=function(e,t){var n=o(e,"negate"),s=o(e,"object"),a=t[3],c=r(e,t),u=n?t[2]:t[1],f=o(e,"message");return"function"==typeof u&&(u=u()),u=u||"",u=u.replace(/#\{this\}/g,function(){return i(s)}).replace(/#\{act\}/g,function(){return i(c)}).replace(/#\{exp\}/g,function(){return i(a)}),f?f+": "+u:u}},function(e,t){/*!
 ...
 * @return {Boolean} result
 */
function l(e,t,n){if(e.size!==t.size)return!1;if(0===e.size)return!0;var o=[],r=[];return e.forEach(function(e,t){o.push([e,t])}),t.forEach(function(e,t){r.push([e,t])}),p(o.sort(),r.sort(),n)}/*!
 ...
 * @return {Boolean} result
 */
function p(e,t,n){var o=e.length;if(o!==t.length)return!1;if(0===o)return!0;for(var r=-1;++r<o;)if(!1===s(e[r],t[r],n))return!1;return!0}/*!
 ...
 * @return {Boolean} result
 */
function h(e,t,n){return p(b(e),b(t),n)}/*!
 ...
 * @return {Boolean} result
 */
function w(e,t,n){var o=g(e),r=g(t);if(o.length&&o.length===r.length)return o.sort(),r.sort(),!1!==p(o,r)&&m(e,t,o,n);var i=y(e),s=y(t);return i.length&&i.length===s.length?(i.sort(),s.sort(),p(i,s,n)):0===o.length&&0===i.length&&0===r.length&&0===s.length}/*!
 ...
 * MIT Licensed
 */
e.exports=function(e,t){function n(e,n){n&&C(this,"message",n),e=e.toLowerCase();var o=C(this,"object"),r=~["a","e","i","o","u"].indexOf(e.charAt(0))?"an ":"a ";this.assert(e===t.type(o).toLowerCase(),"expected #{this} to be "+r+e,"expected #{this} not to be "+r+e)}function o(e,n){return t.isNaN(e)&&t.isNaN(n)||e===n}function r(){C(this,"contains",!0)}function i(e,n){n&&C(this,"message",n);var r=C(this,"object"),i=t.type(r).toLowerCase(),s=C(this,"message"),a=C(this,"negate"),c=C(this,"ssfi"),u=C(this,"deep"),f=u?"deep ":"";s=s?s+": ":"";var l=!1;switch(i){case"string":l=-1!==r.indexOf(e);break;case"weakset":if(u)throw new T(s+"unable to use .deep.include with WeakSet",void 0,c);l=r.has(e);break;case"map":var p=u?t.eql:o;r.forEach(function(t){l=l||p(t,e)});break;case"set":u?r.forEach(function(n){l=l||t.eql(n,e)}):l=r.has(e);break;case"array":l=u?r.some(function(n){return t.eql(n,e)}):-1!==r.indexOf(e);break;default:if(e!==Object(e))throw new T(s+"object tested must be an array, a map, an object, a set, a string, or a weakset, but "+i+" given",void 0,c);var h=Object.keys(e),d=null,y=0;if(h.forEach(function(n){var o=new D(r);if(t.transferFlags(this,o,!0),C(o,"lockSsfi",!0),!a||1===h.length)return void o.property(n,e[n]);try{o.property(n,e[n])}catch(e){if(!t.checkError.compatibleConstructor(e,T))throw e;null===d&&(d=e),y++}},this),a&&h.length>1&&y===h.length)throw d;return}this.assert(l,"expected #{this} to "+f+"include "+t.inspect(e),"expected #{this} to not "+f+"include "+t.inspect(e))}function s(){var e=C(this,"object"),n=t.type(e);this.assert("Arguments"===n,"expected #{this} to be arguments but got "+n,"expected #{this} to not be arguments")}function a(e,t){t&&C(this,"message",t);var n=C(this,"object");if(C(this,"deep"))return this.eql(e);this.assert(e===n,"expected #{this} to equal #{exp}","expected #{this} to not equal #{exp}",e,this._obj,!0)}function c(e,n){n&&C(this,"message",n),this.assert(t.eql(e,C(this,"object")),"expected #{this} to deeply equal #{exp}","expected #{this} to not deeply equal #{exp}",e,this._obj,!0)}function u(e,n){n&&C(this,"message",n);var o=C(this,"object"),r=C(this,"doLength"),i=C(this,"message"),s=i?i+": ":"",a=C(this,"ssfi"),c=t.type(o).toLowerCase(),u=t.type(e).toLowerCase(),f=!0;if(r&&new D(o,i,a,!0).to.have.property("length"),r||"date"!==c||"date"===u)if("number"===u||!r&&"number"!==c)if(r||"date"===c||"number"===c)f=!1;else{var l="string"===c?"'"+o+"'":o;errorMessage=s+"expected "+l+" to be a number or a date"}else errorMessage=s+"the argument to above must be a number";else errorMessage=s+"the argument to above must be a date";if(f)throw new T(errorMessage,void 0,a);if(r){var p=o.length;this.assert(p>e,"expected #{this} to have a length above #{exp} but got #{act}","expected #{this} to not have a length above #{exp}",e,p)}else this.assert(o>e,"expected #{this} to be above #{exp}","expected #{this} to be at most #{exp}",e)}function f(e,n){n&&C(this,"message",n);var o=C(this,"object"),r=C(this,"doLength"),i=C(this,"message"),s=i?i+": ":"",a=C(this,"ssfi"),c=t.type(o).toLowerCase(),u=t.type(e).toLowerCase(),f=!0;if(r&&new D(o,i,a,!0).to.have.property("length"),r||"date"!==c||"date"===u)if("number"===u||!r&&"number"!==c)if(r||"date"===c||"number"===c)f=!1;else{var l="string"===c?"'"+o+"'":o;errorMessage=s+"expected "+l+" to be a number or a date"}else errorMessage=s+"the argument to least must be a number";else errorMessage=s+"the argument to least must be a date";if(f)throw new T(errorMessage,void 0,a);if(r){var p=o.length;this.assert(p>=e,"expected #{this} to have a length at least #{exp} but got #{act}","expected #{this} to have a length below #{exp}",e,p)}else this.assert(o>=e,"expected #{this} to be at least #{exp}","expected #{this} to be below #{exp}",e)}function l(e,n){n&&C(this,"message",n);var o=C(this,"object"),r=C(this,"doLength"),i=C(this,"message"),s=i?i+": ":"",a=C(this,"ssfi"),c=t.type(o).toLowerCase(),u=t.type(e).toLowerCase(),f=!0;if(r&&new D(o,i,a,!0).to.have.property("length"),r||"date"!==c||"date"===u)if("number"===u||!r&&"number"!==c)if(r||"date"===c||"number"===c)f=!1;else{var l="string"===c?"'"+o+"'":o;errorMessage=s+"expected "+l+" to be a number or a date"}else errorMessage=s+"the argument to below must be a number";else errorMessage=s+"the argument to below must be a date";if(f)throw new T(errorMessage,void 0,a);if(r){var p=o.length;this.assert(p<e,"expected #{this} to have a length below #{exp} but got #{act}","expected #{this} to not have a length below #{exp}",e,p)}else this.assert(o<e,"expected #{this} to be below #{exp}","expected #{this} to be at least #{exp}",e)}function p(e,n){n&&C(this,"message",n);var o=C(this,"object"),r=C(this,"doLength"),i=C(this,"message"),s=i?i+": ":"",a=C(this,"ssfi"),c=t.type(o).toLowerCase(),u=t.type(e).toLowerCase(),f=!0;if(r&&new D(o,i,a,!0).to.have.property("length"),r||"date"!==c||"date"===u)if("number"===u||!r&&"number"!==c)if(r||"date"===c||"number"===c)f=!1;else{var l="string"===c?"'"+o+"'":o;errorMessage=s+"expected "+l+" to be a number or a date"}else errorMessage=s+"the argument to most must be a number";else errorMessage=s+"the argument to most must be a date";if(f)throw new T(errorMessage,void 0,a);if(r){var p=o.length;this.assert(p<=e,"expected #{this} to have a length at most #{exp} but got #{act}","expected #{this} to have a length above #{exp}",e,p)}else this.assert(o<=e,"expected #{this} to be at most #{exp}","expected #{this} to be above #{exp}",e)}function h(e,n){n&&C(this,"message",n);var o=C(this,"object"),r=C(this,"ssfi"),i=C(this,"message");try{var s=o instanceof e}catch(n){if(n instanceof TypeError)throw i=i?i+": ":"",new T(i+"The instanceof assertion needs a constructor but "+t.type(e)+" was given.",void 0,r);throw n}var a=t.getName(e);null===a&&(a="an unnamed constructor"),this.assert(s,"expected #{this} to be an instance of "+a,"expected #{this} to not be an instance of "+a)}function d(e,n,o){o&&C(this,"message",o);var r=C(this,"nested"),i=C(this,"own"),s=C(this,"message"),a=C(this,"object"),c=C(this,"ssfi");if(r&&i)throw s=s?s+": ":"",new T(s+'The "nested" and "own" flags cannot be combined.',void 0,c);if(null===a||void 0===a)throw s=s?s+": ":"",new T(s+"Target cannot be null or undefined.",void 0,c);var u=C(this,"deep"),f=C(this,"negate"),l=r?t.getPathInfo(a,e):null,p=r?l.value:a[e],h="";u&&(h+="deep "),i&&(h+="own "),r&&(h+="nested "),h+="property ";var d;d=i?Object.prototype.hasOwnProperty.call(a,e):r?l.exists:t.hasProperty(a,e),f&&1!==arguments.length||this.assert(d,"expected #{this} to have "+h+t.inspect(e),"expected #{this} to not have "+h+t.inspect(e)),arguments.length>1&&this.assert(d&&(u?t.eql(n,p):n===p),"expected #{this} to have "+h+t.inspect(e)+" of #{exp}, but got #{act}","expected #{this} to not have "+h+t.inspect(e)+" of #{act}",n,p),C(this,"object",p)}function y(e,t,n){C(this,"own",!0),d.apply(this,arguments)}function b(e,n,o){"string"==typeof n&&(o=n,n=null),o&&C(this,"message",o);var r=C(this,"object"),i=Object.getOwnPropertyDescriptor(Object(r),e);i&&n?this.assert(t.eql(n,i),"expected the own property descriptor for "+t.inspect(e)+" on #{this} to match "+t.inspect(n)+", got "+t.inspect(i),"expected the own property descriptor for "+t.inspect(e)+" on #{this} to not match "+t.inspect(n),n,i,!0):this.assert(i,"expected #{this} to have an own property descriptor for "+t.inspect(e),"expected #{this} to not have an own property descriptor for "+t.inspect(e)),C(this,"object",i)}function g(){C(this,"doLength",!0)}function m(e,t){t&&C(this,"message",t);var n=C(this,"object"),o=C(this,"message"),r=C(this,"ssfi");new D(n,o,r,!0).to.have.property("length");var i=n.length;this.assert(i==e,"expected #{this} to have a length of #{exp} but got #{act}","expected #{this} to not have a length of #{act}",e,i)}function w(e,t){t&&C(this,"message",t);var n=C(this,"object");this.assert(e.exec(n),"expected #{this} to match "+e,"expected #{this} not to match "+e)}function v(e){var n,o=C(this,"object"),r=t.type(o),i=t.type(e),s=C(this,"ssfi"),a=C(this,"deep"),c="",u=!0,f=C(this,"message");f=f?f+": ":"";var l=f+"when testing keys against an object or an array you must give a single Array|Object|String argument or multiple String arguments";if("Map"===r||"Set"===r)c=a?"deeply ":"",p=[],o.forEach(function(e,t){p.push(t)}),"Array"!==i&&(e=Array.prototype.slice.call(arguments));else{switch(p=t.getOwnEnumerableProperties(o),i){case"Array":if(arguments.length>1)throw new T(l,void 0,s);break;case"Object":if(arguments.length>1)throw new T(l,void 0,s);e=Object.keys(e);break;default:e=Array.prototype.slice.call(arguments)}e=e.map(function(e){return"symbol"==typeof e?e:String(e)})}if(!e.length)throw new T(f+"keys required",void 0,s);var p,h=e.length,d=C(this,"any"),y=C(this,"all"),b=e;if(d||y||(y=!0),d&&(u=b.some(function(e){return p.some(function(n){return a?t.eql(e,n):e===n})})),y&&(u=b.every(function(e){return p.some(function(n){return a?t.eql(e,n):e===n})}),C(this,"contains")||(u=u&&e.length==p.length)),h>1){e=e.map(function(e){return t.inspect(e)});var g=e.pop();y&&(n=e.join(", ")+", and "+g),d&&(n=e.join(", ")+", or "+g)}else n=t.inspect(e[0]);n=(h>1?"keys ":"key ")+n,n=(C(this,"contains")?"contain ":"have ")+n,this.assert(u,"expected #{this} to "+c+n,"expected #{this} to not "+c+n,b.slice(0).sort(t.compareByInspect),p.sort(t.compareByInspect),!0)}function x(e,n,o){o&&C(this,"message",o);var r=C(this,"object"),i=C(this,"ssfi"),s=C(this,"message"),a=C(this,"negate")||!1;new D(r,s,i,!0).is.a("function"),(e instanceof RegExp||"string"==typeof e)&&(n=e,e=null);var c;try{r()}catch(e){c=e}var u=void 0===e&&void 0===n,f=Boolean(e&&n),l=!1,p=!1;if(u||!u&&!a){var h="an error";e instanceof Error?h="#{exp}":e&&(h=t.checkError.getConstructorName(e)),this.assert(c,"expected #{this} to throw "+h,"expected #{this} to not throw an error but #{act} was thrown",e&&e.toString(),c instanceof Error?c.toString():"string"==typeof c?c:c&&t.checkError.getConstructorName(c))}if(e&&c){if(e instanceof Error){t.checkError.compatibleInstance(c,e)===a&&(f&&a?l=!0:this.assert(a,"expected #{this} to throw #{exp} but #{act} was thrown","expected #{this} to not throw #{exp}"+(c&&!a?" but #{act} was thrown":""),e.toString(),c.toString()))}t.checkError.compatibleConstructor(c,e)===a&&(f&&a?l=!0:this.assert(a,"expected #{this} to throw #{exp} but #{act} was thrown","expected #{this} to not throw #{exp}"+(c?" but #{act} was thrown":""),e instanceof Error?e.toString():e&&t.checkError.getConstructorName(e),c instanceof Error?c.toString():c&&t.checkError.getConstructorName(c)))}if(c&&void 0!==n&&null!==n){var d="including";n instanceof RegExp&&(d="matching");t.checkError.compatibleMessage(c,n)===a&&(f&&a?p=!0:this.assert(a,"expected #{this} to throw error "+d+" #{exp} but got #{act}","expected #{this} to throw error not "+d+" #{exp}",n,t.checkError.getMessage(c)))}l&&p&&this.assert(a,"expected #{this} to throw #{exp} but #{act} was thrown","expected #{this} to not throw #{exp}"+(c?" but #{act} was thrown":""),e instanceof Error?e.toString():e&&t.checkError.getConstructorName(e),c instanceof Error?c.toString():c&&t.checkError.getConstructorName(c)),C(this,"object",c)}function M(e,n){n&&C(this,"message",n);var o=C(this,"object"),r=C(this,"itself"),i="function"!=typeof o||r?o[e]:o.prototype[e];this.assert("function"==typeof i,"expected #{this} to respond to "+t.inspect(e),"expected #{this} to not respond to "+t.inspect(e))}function O(e,n){n&&C(this,"message",n);var o=C(this,"object"),r=e(o);this.assert(r,"expected #{this} to satisfy "+t.objDisplay(e),"expected #{this} to not satisfy"+t.objDisplay(e),!C(this,"negate"),r)}function j(e,t,n){n&&C(this,"message",n);var o=C(this,"object"),r=C(this,"message"),i=C(this,"ssfi");if(new D(o,r,i,!0).is.a("number"),"number"!=typeof e||"number"!=typeof t)throw r=r?r+": ":"",new T(r+"the arguments to closeTo or approximately must be numbers",void 0,i);this.assert(Math.abs(o-e)<=t,"expected #{this} to be close to "+e+" +/- "+t,"expected #{this} not to be close to "+e+" +/- "+t)}function S(e,t,n,o,r){if(!o){if(e.length!==t.length)return!1;t=t.slice()}return e.every(function(e,i){if(r)return n?n(e,t[i]):e===t[i];if(!n){var s=t.indexOf(e);return-1!==s&&(o||t.splice(s,1),!0)}return t.some(function(r,i){return!!n(e,r)&&(o||t.splice(i,1),!0)})})}function P(e,t){t&&C(this,"message",t);var n=C(this,"object"),o=C(this,"message"),r=C(this,"ssfi");new D(e,o,r,!0).to.be.an("array"),this.assert(e.indexOf(n)>-1,"expected #{this} to be one of #{exp}","expected #{this} to not be one of #{exp}",e,n)}function N(e,t,n){n&&C(this,"message",n);var o=C(this,"object"),r=C(this,"message"),i=C(this,"ssfi");new D(o,r,i,!0).is.a("function");var s;t?(new D(e,r,i,!0).to.have.property(t),s=e[t]):(new D(e,r,i,!0).is.a("function"),s=e()),o();var a=void 0===t||null===t?e():e[t],c=void 0===t||null===t?s:"."+t;C(this,"deltaMsgObj",c),C(this,"initialDeltaValue",s),C(this,"finalDeltaValue",a),C(this,"deltaBehavior","change"),C(this,"realDelta",a!==s),this.assert(s!==a,"expected "+c+" to change","expected "+c+" to not change")}function k(e,t,n){n&&C(this,"message",n);var o=C(this,"object"),r=C(this,"message"),i=C(this,"ssfi");new D(o,r,i,!0).is.a("function");var s;t?(new D(e,r,i,!0).to.have.property(t),s=e[t]):(new D(e,r,i,!0).is.a("function"),s=e()),new D(s,r,i,!0).is.a("number"),o();var a=void 0===t||null===t?e():e[t],c=void 0===t||null===t?s:"."+t;C(this,"deltaMsgObj",c),C(this,"initialDeltaValue",s),C(this,"finalDeltaValue",a),C(this,"deltaBehavior","increase"),C(this,"realDelta",a-s),this.assert(a-s>0,"expected "+c+" to increase","expected "+c+" to not increase")}function E(e,t,n){n&&C(this,"message",n);var o=C(this,"object"),r=C(this,"message"),i=C(this,"ssfi");new D(o,r,i,!0).is.a("function");var s;t?(new D(e,r,i,!0).to.have.property(t),s=e[t]):(new D(e,r,i,!0).is.a("function"),s=e()),new D(s,r,i,!0).is.a("number"),o();var a=void 0===t||null===t?e():e[t],c=void 0===t||null===t?s:"."+t;C(this,"deltaMsgObj",c),C(this,"initialDeltaValue",s),C(this,"finalDeltaValue",a),C(this,"deltaBehavior","decrease"),C(this,"realDelta",s-a),this.assert(a-s<0,"expected "+c+" to decrease","expected "+c+" to not decrease")}function A(e,t){t&&C(this,"message",t);var n,o=C(this,"deltaMsgObj"),r=C(this,"initialDeltaValue"),i=C(this,"finalDeltaValue"),s=C(this,"deltaBehavior"),a=C(this,"realDelta");n="change"===s?Math.abs(i-r)===Math.abs(e):a===Math.abs(e),this.assert(n,"expected "+o+" to "+s+" by "+e,"expected "+o+" to not "+s+" by "+e)}var D=e.Assertion,T=e.AssertionError,C=t.flag;["to","be","been","is","and","has","have","with","that","which","at","of","same","but","does"].forEach(function(e){D.addProperty(e)}),D.addProperty("not",function(){C(this,"negate",!0)}),D.addProperty("deep",function(){C(this,"deep",!0)}),D.addProperty("nested",function(){C(this,"nested",!0)}),D.addProperty("own",function(){C(this,"own",!0)}),D.addProperty("ordered",function(){C(this,"ordered",!0)}),D.addProperty("any",function(){C(this,"any",!0),C(this,"all",!1)}),D.addProperty("all",function(){C(this,"all",!0),C(this,"any",!1)}),D.addChainableMethod("an",n),D.addChainableMethod("a",n),D.addChainableMethod("include",i,r),D.addChainableMethod("contain",i,r),D.addChainableMethod("contains",i,r),D.addChainableMethod("includes",i,r),D.addProperty("ok",function(){this.assert(C(this,"object"),"expected #{this} to be truthy","expected #{this} to be falsy")}),D.addProperty("true",function(){this.assert(!0===C(this,"object"),"expected #{this} to be true","expected #{this} to be false",!C(this,"negate"))}),D.addProperty("false",function(){this.assert(!1===C(this,"object"),"expected #{this} to be false","expected #{this} to be true",!!C(this,"negate"))}),D.addProperty("null",function(){this.assert(null===C(this,"object"),"expected #{this} to be null","expected #{this} not to be null")}),D.addProperty("undefined",function(){this.assert(void 0===C(this,"object"),"expected #{this} to be undefined","expected #{this} not to be undefined")}),D.addProperty("NaN",function(){this.assert(t.isNaN(C(this,"object")),"expected #{this} to be NaN","expected #{this} not to be NaN")}),D.addProperty("exist",function(){var e=C(this,"object");this.assert(null!==e&&void 0!==e,"expected #{this} to exist","expected #{this} to not exist")}),D.addProperty("empty",function(){var e,n=C(this,"object"),o=C(this,"ssfi"),r=C(this,"message");switch(r=r?r+": ":"",t.type(n).toLowerCase()){case"array":case"string":e=n.length;break;case"map":case"set":e=n.size;break;case"weakmap":case"weakset":throw new T(r+".empty was passed a weak collection",void 0,o);case"function":var i=r+".empty was passed a function "+t.getName(n);throw new T(i.trim(),void 0,o);default:if(n!==Object(n))throw new T(r+".empty was passed non-string primitive "+t.inspect(n),void 0,o);e=Object.keys(n).length}this.assert(0===e,"expected #{this} to be empty","expected #{this} not to be empty")}),D.addProperty("arguments",s),D.addProperty("Arguments",s),D.addMethod("equal",a),D.addMethod("equals",a),D.addMethod("eq",a),D.addMethod("eql",c),D.addMethod("eqls",c),D.addMethod("above",u),D.addMethod("gt",u),D.addMethod("greaterThan",u),D.addMethod("least",f),D.addMethod("gte",f),D.addMethod("below",l),D.addMethod("lt",l),D.addMethod("lessThan",l),D.addMethod("most",p),D.addMethod("lte",p),D.addMethod("within",function(e,n,o){o&&C(this,"message",o);var r=C(this,"object"),i=C(this,"doLength"),s=C(this,"message"),a=s?s+": ":"",c=C(this,"ssfi"),u=t.type(r).toLowerCase(),f=t.type(e).toLowerCase(),l=t.type(n).toLowerCase(),p=!0,h="date"===f&&"date"===l?e.toUTCString()+".."+n.toUTCString():e+".."+n;if(i&&new D(r,s,c,!0).to.have.property("length"),i||"date"!==u||"date"===f&&"date"===l)if("number"===f&&"number"===l||!i&&"number"!==u)if(i||"date"===u||"number"===u)p=!1;else{var d="string"===u?"'"+r+"'":r;errorMessage=a+"expected "+d+" to be a number or a date"}else errorMessage=a+"the arguments to within must be numbers";else errorMessage=a+"the arguments to within must be dates";if(p)throw new T(errorMessage,void 0,c);if(i){var y=r.length;this.assert(y>=e&&y<=n,"expected #{this} to have a length within "+h,"expected #{this} to not have a length within "+h)}else this.assert(r>=e&&r<=n,"expected #{this} to be within "+h,"expected #{this} to not be within "+h)}),D.addMethod("instanceof",h),D.addMethod("instanceOf",h),D.addMethod("property",d),D.addMethod("ownProperty",y),D.addMethod("haveOwnProperty",y),D.addMethod("ownPropertyDescriptor",b),D.addMethod("haveOwnPropertyDescriptor",b),D.addChainableMethod("length",m,g),D.addChainableMethod("lengthOf",m,g),D.addMethod("match",w),D.addMethod("matches",w),D.addMethod("string",function(e,n){n&&C(this,"message",n);var o=C(this,"object"),r=C(this,"message"),i=C(this,"ssfi");new D(o,r,i,!0).is.a("string"),this.assert(~o.indexOf(e),"expected #{this} to contain "+t.inspect(e),"expected #{this} to not contain "+t.inspect(e))}),D.addMethod("keys",v),D.addMethod("key",v),D.addMethod("throw",x),D.addMethod("throws",x),D.addMethod("Throw",x),D.addMethod("respondTo",M),D.addMethod("respondsTo",M),D.addProperty("itself",function(){C(this,"itself",!0)}),D.addMethod("satisfy",O),D.addMethod("satisfies",O),D.addMethod("closeTo",j),D.addMethod("approximately",j),D.addMethod("members",function(e,n){n&&C(this,"message",n);var o=C(this,"object"),r=C(this,"message"),i=C(this,"ssfi");new D(o,r,i,!0).to.be.an("array"),new D(e,r,i,!0).to.be.an("array");var s,a,c,u=C(this,"contains"),f=C(this,"ordered");u?(s=f?"an ordered superset":"a superset",a="expected #{this} to be "+s+" of #{exp}",c="expected #{this} to not be "+s+" of #{exp}"):(s=f?"ordered members":"members",a="expected #{this} to have the same "+s+" as #{exp}",c="expected #{this} to not have the same "+s+" as #{exp}");var l=C(this,"deep")?t.eql:void 0;this.assert(S(e,o,l,u,f),a,c,e,o,!0)}),D.addMethod("oneOf",P),D.addMethod("change",N),D.addMethod("changes",N),D.addMethod("increase",k),D.addMethod("increases",k),D.addMethod("decrease",E),D.addMethod("decreases",E),D.addMethod("by",A),D.addProperty("extensible",function(){var e=C(this,"object"),t=e===Object(e)&&Object.isExtensible(e);this.assert(t,"expected #{this} to be extensible","expected #{this} to not be extensible")}),D.addProperty("sealed",function(){var e=C(this,"object"),t=e!==Object(e)||Object.isSealed(e);this.assert(t,"expected #{this} to be sealed","expected #{this} to not be sealed")}),D.addProperty("frozen",function(){var e=C(this,"object"),t=e!==Object(e)||Object.isFrozen(e);this.assert(t,"expected #{this} to be frozen","expected #{this} to not be frozen")}),D.addProperty("finite",function(e){var t=C(this,"object");this.assert("number"==typeof t&&isFinite(t),"expected #{this} to be a finite number","expected #{this} to not be a finite number")})}},function(e,t){/*!
 * chai
 * Copyright(c) 2011-2014 Jake Luer <jake@alogicalparadox.com>
 * MIT Licensed
 */
